...
import { User, Mail, MapPin, Camera, Save, Globe, Heart, FileText, Trash2 } from 'lucide-react';
...
const UserProfile: React.FC = () => {
  ...
  const [savedDestinations, setSavedDestinations] = useState<
    { id: string; name: string; image: string; savedDate: string }[]
  >([]);

  // Load profile data and saved destinations from localStorage
  useEffect(() => {
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="relative px-8 pb-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-end space-y-4 sm:space-y-0 sm:space-x-6 -mt-10">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Saved on {new Date(destination.savedDate).toLocaleDateString()}
                    </p>
                  </div>
                  <button
